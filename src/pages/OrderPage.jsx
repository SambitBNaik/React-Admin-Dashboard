...
import OrderDistrubution from '../components/orders/OrderDistrubution';
   ...
   <div className='flex-1 relative z-10 overflow-auto'>
    ...
    <main className='max-w-7xl mx-auto py-6 px-4 lg:px-8'>
      ...
      >
        ...
        <StatCard name='Total Revenu' icon={DollarSign} value={orderStats.totalRevenue} color="#EF4444"/>
      </motion.div>
