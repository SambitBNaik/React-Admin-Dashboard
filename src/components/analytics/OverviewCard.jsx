...
const OverviewCard = () => {
  return (
    <div className='grid grid-cols-1 gap-5 sm:grid-cols-2 lg:gird-cols-4 mb-8'>
        { overviewData.map((item, index)=>(
            ...
            >
                <div className='flex items-center justify-between'>
                    ...
                    <div
                    className={`p-3 rounded-full bg-opacity-20 ${item.change>=0 ? "bg-screen-500":"bg-red-500"}`}
                    >
